...
export default {
  title: 'StyledUi/WidgetUi/variants/HorizontalWidget',
  component: HorizontalWidget,
...
} as ComponentMeta<typeof HorizontalWidget>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: ComponentStory<typeof HorizontalWidget> = (args) => {
  return <HorizontalWidget {...args} />;
};
