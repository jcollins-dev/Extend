...
export default {
  title: 'StyledUi/WidgetUi/variants/DatePickerWidget',
...
} as ComponentMeta<typeof DatePickerWidget>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: ComponentStory<typeof DatePickerWidget> = (args) => {
  return <DatePickerWidget {...args} />;
};
