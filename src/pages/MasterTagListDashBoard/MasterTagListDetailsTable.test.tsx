...
// Types
import { MasterTagListColumn, WipTagListRowData, TagListRowStatus } from 'types/machine-management';
        ...
        <ThemeProvider theme={theme}>
          <Route path={JBTRoutes.machineMasterTagListDashBoard}>
            <MasterTagListDetailsTable
              tagListData={testRowData}
              updateTagListData={jest.fn()}
              updateTagListWithErrorsData={jest.fn()}
